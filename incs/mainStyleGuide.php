...
echo'   <div class="largeContent">
            <div class="insideLargeContent">
                ...
                <div class="colourSwatch">
                    Primary Colours
                    <span class="primaryColour" class="colourDemo">
                        #4CAF50
                    </span>
                    <span class="secondaryColour" class="colourDemo">
                        #388E3C
                    </span>
                    <span class="tertiaryColour" class="colourDemo">
                        #C8E6C9
                    </span>
                </div>
                <div class="colourSwatch">
                    Accent Colours
                    <span class="primaryColourAccent" class="colourDemo">
                        #2196F3
                    </span>
                    <span class="secondaryColourAccent" class="colourDemo">
                        #1976D2
                    </span>
                    <span class="tertiaryColourAccent" class="colourDemo">
                        #BBDEFB
                    </span>
                </div>
                <span>Potential Logo<img src="images/logo.svg" height="100px" width="100px"></img></span> 
                <!--TODO h1/h2/h3, p tag font size-->
            </div>
        </div>';
