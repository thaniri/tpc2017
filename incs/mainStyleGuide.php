...
echo'<main class="borderDemo">
            ...
            <div class="colourSwatch">
                Primary Colours
                <span id="primaryColour" class="colourDemo">
                    #4CAF50
                </span>
                <span id="secondaryColour" class="colourDemo">
                    #388E3C
                </span>
                <span id="tertiaryColour" class="colourDemo">
                    #C8E6C9
                </span>
            </div>
            <div class="colourSwatch">
                Accent Colours
                <span id="primaryColourAccent" class="colourDemo">
                    #2196F3
                </span>
                <span id="secondaryColourAccent" class="colourDemo">
                    #1976D2
                </span>
                <span id="tertiaryColourAccent" class="colourDemo">
                    #BBDEFB
                </span>
            </div>
